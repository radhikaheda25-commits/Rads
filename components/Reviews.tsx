    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {REVIEWS.map((review) => (
            <div key={review.id} className="bg-cream/20 p-8 rounded-3xl border border-blush/10 hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex items-center space-x-4">
                <div className="w-10 h-10 bg-blush/30 rounded-full flex items-center justify-center font-serif text-blush">{review.author.charAt(0)}</div>
                <div>
